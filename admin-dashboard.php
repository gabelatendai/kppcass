							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="ncs" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-all')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?ncjan=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
										<div id="div-id-all">
                                            <?php
									...
									<div aria-labelledby="home-tab" id="home5" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-male')"><h3 style="color:#000000">Print List</h3></a>
									...
									<div aria-labelledby="profile-tab" id="profile5" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-female')"><h3 style="color:#000000">Print List</h3></a>
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nc-may" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-ncmay')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?ncmay=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nc-may" class="tab-pane fade " role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-ncm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-ncm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nc-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-ncf')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-ncf">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd1-jan" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1j')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd1jan=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd1-jan" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1jm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1jm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nd1-jan" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1f')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1f">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd1-may" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1may')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd1may=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd1-may" class="tab-pane fade " role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1mm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1mm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nd1-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1ff')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1ff">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd2-jan" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2j')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd2jan=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd2-jan" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2m')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2m">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nd2-jan" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2f')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2f">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd2-may" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2may')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd2may=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd2-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2mm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2mm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nd2-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2fm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2fm">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd3-jan" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd3jan=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd3-jan" class="tab-pane fade " role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3m')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3m">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nd3-jan" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3f')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3f">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd3-may" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3may')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd3may=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd3-may" class="tab-pane fade " role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3mm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3mm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-nd3-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3fm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3fm">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-hnd-jan" class="tab-pane fade active in" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hnd')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?hndjan=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-hnd-jan" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-hndm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-hnd-jan" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndf')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-hndf">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-hnd-may" class="tab-pane fade active " role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndmay')"><h3 style="color:#000000">Print List</h3></a>
										<a href="functions.php?hndmay=true"><img src="images/xcel.png" width="20px" height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-hnd-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndmm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-hndmm">
                                            <?php
									...
									<div aria-labelledby="profile-tab" id="female-hnd-may" class="tab-pane fade" role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndfm')"><h3 style="color:#000000">Print List</h3></a>
										<div id="div-id-hndfm">
                                            <?php
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="ncs" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-all')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?ncjan=true"><img src="images/xcel.png" width="20px"
										                                        height="20px">Export</a>
										<div id="div-id-all">
                                            <?php
                                            $all = R::count('students', 'level = ? AND intake =? ', ['nc', '0']);
											...
											<div class="table-responsive col-md-offset-1">
												<table cellpadding="0" border="1" width="1200"
									...
									<div aria-labelledby="home-tab" id="home5" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-male')"><h3
													style="color:#000000">Print List</h3></a>
										...
										<div id="div-id-male">
											...
											<div class="table-responsive col-md-offset-1">
												<table cellpadding="0" border="1" width="1500"
												       class="table  table-striped table-condensed table-hover dataTables table-bordered"
												       id="myTable2">
									...
									<div aria-labelledby="profile-tab" id="profile5" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-female')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-female">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nc', 'female', '0']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nc-may" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-ncmay')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?ncmay=true"><img src="images/xcel.png" width="20px"
										                                        height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nc-may" class="tab-pane fade "
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-ncm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-ncm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nc', 'male', '1']);
									...
									<div aria-labelledby="profile-tab" id="female-nc-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-ncf')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-ncf">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nc', 'female', '1']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd1-jan" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1j')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd1jan=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd1-jan" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1jm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1jm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd1', 'male', '0']);
									...
									<div aria-labelledby="profile-tab" id="female-nd1-jan" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1f')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1f">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd1', 'female', '0']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd1-may" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1may')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd1may=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd1-may" class="tab-pane fade "
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1mm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1mm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd1', 'male', '1']);
									...
									<div aria-labelledby="profile-tab" id="female-nd1-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd1ff')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd1ff">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd1', 'female', '1']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd2-jan" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2j')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd2jan=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd2-jan" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2m')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2m">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd2', 'male', '0']);
									...
									<div aria-labelledby="profile-tab" id="female-nd2-jan" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2f')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2f">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd2', 'female', '0']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd2-may" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2may')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd2may=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd2-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2mm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2mm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd2', 'male', '1']);
									...
									<div aria-labelledby="profile-tab" id="female-nd2-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd2fm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd2fm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd2', 'female', '1']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd3-jan" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd3jan=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd3-jan" class="tab-pane fade "
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3m')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3m">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd3', 'male', '0']);
									...
									<div aria-labelledby="profile-tab" id="female-nd3-jan" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3f')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3f">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd3', 'female', '0']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-nd3-may" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3may')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?nd3may=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-nd3-may" class="tab-pane fade "
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3mm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3mm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd3', 'male', '1']);
									...
									<div aria-labelledby="profile-tab" id="female-nd3-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-nd3fm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-nd3fm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['nd3', 'female', '1']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-hnd-jan" class="tab-pane fade active in"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hnd')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?hndjan=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-hnd-jan" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-hndm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['hnd', 'male', '0']);
									...
									<div aria-labelledby="profile-tab" id="female-hnd-jan" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndf')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-hndf">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['hnd', 'female', '0']);
							...
							<div data-example-id="togglable-tabs" class="bs-example bs-example-tabs">
								...
								<div class="tab-content" id="myTabContent">
									<div aria-labelledby="home-tab" id="all-hnd-may" class="tab-pane fade active "
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndmay')"><h3
													style="color:#000000">Print List</h3></a>
										<a href="functions.php?hndmay=true"><img src="images/xcel.png" width="20px"
										                                         height="20px">Export</a>
									...
									<div aria-labelledby="home-tab" id="male-hnd-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndmm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-hndmm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['hnd', 'male', '1']);
									...
									<div aria-labelledby="profile-tab" id="female-hnd-may" class="tab-pane fade"
									     role="tabpanel">
										<a href="#" id="print" onClick="javascript:printlayer('div-id-hndfm')"><h3
													style="color:#000000">Print List</h3></a>
										<div id="div-id-hndfm">
                                            <?php
                                            $all = R::count('students', 'level = ? AND gender = ? AND intake =? ', ['hnd', 'female', '1']);
