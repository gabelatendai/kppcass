...
if (isset($_POST['register'])){
    ...
    mysqli_query($conn,"UPDATE `staff` SET `firstname`='$firstname',`lastname`='$lastname',`idno`='$idno',
`dateofbirth`='$dateofbirth',`gender`='$gender',`mobile`='$mobile',
`address`='$address',`zipcode`='$zipcode',`department_id`='$department_id' WHERE `id`='$staff_id'");

   //mysqli_query($conn,"UPDATE `users` SET `email`='$email' WHERE `id`= '$adm'");
