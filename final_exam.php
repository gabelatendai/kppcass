...
//$cos = $_GET['course'];
$query=mysqli_query($conn,"select * from studentmarks where course='$id'")or die(mysql_error());
...
if (isset($_POST['update'])){
    ...
    mysqli_query($conn," UPDATE studentmarks SET  exam_mark='$exam_mark' WHERE course = '$id' and admission_number ='$number'")or die(mysql_error());
...
<div class="tab-content">
    <div class="tab-pane active" role="tabpanel" id="tab-1">
        ...
        <div class="table-responsive"  >
            ...
            <!--*************************************************************************************************************************-->
         <h2 align="center">Final Exam Mark</h2>   <div class="container-fluid">
                <div class="row">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
	                                    ...
	                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
		                                    <div class="form-group">
			                                    ...
			                                    <input type="number" name="exam_mark" id="b" class="form-control"  value="<?php echo $row['exam_mark']; ?>" onkeyup="final()" max="100" >
