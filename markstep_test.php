...
if (isset($_POST['update'])){
    ...
    if($init > 0){
        $pra=$_POST['test1'];
        mysqli_query($conn," UPDATE studentmarks SET  test1 ='$pra' WHERE course = '$id' and admission_number ='$number'");
			                                ...
			                                <div class="row">
				                                ...
				                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
					                                <div class="form-group">
						                                ...
						                                <input type="number" name="test1" id="d" class="form-control"  value="<?php echo $studentmarks->test1 ?>" onkeyup="final()" max="100" >
