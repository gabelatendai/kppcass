...
if (isset($_POST['update'])){
    ...
    mysqli_query($conn," UPDATE studentmarks SET theory2='$theory2' WHERE course = '$id' and admission_number ='$number'");
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
	                                    ...
	                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
		                                    <div class="form-group">
			                                    ...
			                                    <input type="number" name="theory" id="d" class="form-control"  value="<?php echo $row['theory2']; ?>" onkeyup="final()" max="100" >
