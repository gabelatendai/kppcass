...
$user=mysqli_query($conn,"SELECT * from students where admission_number = '$id'");
...
<div class="tab-content">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
	        ...
	        <td><a button type='button' class="btn btn-primary" href="markstep2.php">Back</a></td></tr>
                        ...
                        <div class="table-responsive">
	                        ...
	                        <thead>
                                  ...
                                  //  foreach ($student as $stud) {
                                    ...
                                    $user_query=mysqli_query($conn,"SELECT * from studentmarks where admission_number = '$id'");
